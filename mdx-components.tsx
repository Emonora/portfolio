...
const components = {
  h1: (props: HeadingProps) => (
    <h1 className="mb-0 pt-12 text-4xl font-medium fade-in" {...props} />
  ),
  h2: (props: HeadingProps) => (
    <h2 className="mb-3 mt-8 text-3xl font-medium text-gray-800" {...props} />
  ),
  h3: (props: HeadingProps) => (
    <h3 className="mb-3 mt-8 text-2xl font-medium text-gray-800" {...props} />
  ),
